...
namespace MauiApp1.Services
{
    public class APIService
    {
        ...
        public static string BaseAddress = DeviceInfo.Platform == DevicePlatform.Android ? "https://c4p8s8d6-5045.euw.devtunnels.ms/api/" : "http://localhost:5045/api/";
        private static string ImageBaseAddress = DeviceInfo.Platform == DevicePlatform.Android ? "https://c4p8s8d6-5045.euw.devtunnels.ms/" : "http://localhost:5045";
